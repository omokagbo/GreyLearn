...
struct Course: Codable, Hashable {
    ...
    var stage: (text: String, progress: Float) {
        ...
        let stageText = "Stage \(Int(unlockedCount)) of \(Int(totalCount))"
    ...
    static let mockCourse = Course(
        ...
        modules: [
            Module(
                ...
                dateStarted: "22/02/2026",
                dateCompleted: "22/02/2026"
            ),
            ...
            Module(
                ...
                dateStarted: "23/02/2026",
                dateCompleted: "23/02/2026"
            ),
            ...
            Module(
                ...
                sections: [
                    Section(
                        ...
                        topics: [
                            Topic(
                                id: 311,
                                courseId: mockCourseIntId,
                                name: "Build a login screen in React",
                                description: "Create a simple login screen using functional components, state, and basic validation.",
                                isCompleted: false,
                            ...
                            Topic(
                                id: 312,
                                courseId: mockCourseIntId,
                                name: "Refactor login to use useEffect",
                                description: "Add lifecycle behavior (e.g. form state sync, side effects) using useEffect.",
                                isCompleted: false,
                ...
                dateStarted: "24/02/2026",
                dateCompleted: nil
            ),

            Module(
                id: 4,
                name: "Core Mobile UI Build",
